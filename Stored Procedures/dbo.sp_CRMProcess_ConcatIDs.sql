...
SELECT        CASE WHEN @ObjectType = 'Account' THEN ssb_crmsystem_contactacct_id ELSE [SSB_CRMSYSTEM_CONTACT_ID] END GUID, CAST(DimCustomerId AS VARCHAR(100)) AS DimCustomerID, CAST(SSID AS VARCHAR(50)) AS SSID
, a.SourceSystem
INTO #tmpDimCustIDs
